...
KalmanNet은 **model-based + data-driven hybrid** 실시간 상태 추정기. 고전적 Kalman Filter (KF)의 연산 흐름을 유지하면서, Kalman gain 계산을 compact RNN (GRU)으로 대체하여 **부분적으로만 알려진 dynamics**에서도 동작함. (Revach et al. 2022, IEEE TSP)
