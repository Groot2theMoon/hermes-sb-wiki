...
- [[action-conditional-recurrent-kalman-network]] — ac-RKN (Shaj et al., CoRL 2020): RKN을 **action-conditional prediction + inverse dynamics**로 확장. KalmanNet과 같은 neural Kalman 계열이지만 **principled action conditioning**과 **forward/inverse joint learning**에 특화.
