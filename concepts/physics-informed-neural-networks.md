...
**PINN**은 [[maziar-raissi|Raissi]], [[paris-perdikaris|Perdikaris]], [[george-em-karniadakis|Karniadakis]] (2019)가 제안한 방법으로, 신경망이 PDE residual을 손실 함수에 직접 포함하여 **데이터 없이 물리 법칙만으로** 해를 근사한다.
