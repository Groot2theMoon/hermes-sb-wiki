...
흡음 성능 예측은 [[transfer-matrix-method-acoustic-porous|TMM]] (Transfer Matrix Method)을 통해 JCA 5-parameter로부터 α(f)를 계산. Python 오픈소스 패키지 `acoustipy`가 Allard & Atalla (2009) 기반 구현 제공. DMN → TMM end-to-end 연결이 핵심 기술 과제.
